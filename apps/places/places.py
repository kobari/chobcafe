...
class Places:
    ...
    def place_photos(self):
        models = PlacesModel.objects.exclude(photos=None)
        model_details = PlaceDetails.objects.exclude(photos=None)
        for model in models:
    ...
    def places_update_or_create(self):
            ...
            for i in range(1, 4):
                ...
                with open(filepath, 'r') as fp:
                    ...
                    for item in data['results']:
                        PlacesModel.objects.update_or_create(
    ...
    def place_details_update_or_create(self):
        ...
        with transaction.atomic():
            for filepath in p.glob('*.json'):
                ...
                with open(filepath, 'r') as fp:
                    data = json.load(fp)
                    item = data['result']
                    PlaceDetails.objects.update_or_create(
